...
class ModelSite:
    ...
    allow_views = (
        ...
        "detail",
        "delete",
    )  # Says superadmin which views create
    ...
    def __init__(self, model, **kwargs):
        ...
        self.breadcrumb_home_text = getattr(
            self, "breadcrumb_home_text", settings.BREADCRUMB_HOME_TEXT
        )
        self.breadcrumb_create_text = getattr(
            self, "breadcrumb_create_text", settings.BREADCRUMB_CREATE_TEXT
        )
        self.breadcrumb_update_text = getattr(
            self, "breadcrumb_update_text", settings.BREADCRUMB_UPDATE_TEXT
        )
        self.breadcrumb_detail_text = getattr(
            self, "breadcrumb_detail_text", settings.BREADCRUMB_DETAIL_TEXT
        )
        self.breadcrumb_delete_text = getattr(
            self, "breadcrumb_delete_text", settings.BREADCRUMB_DELETE_TEXT
        )
